...
public partial class AudioMixerSaver : FileScriptableInterface
{
    [Serializable]
    ...
    public AudioMixer AudioMixer { get { return mixer; } }
    ...
    public void SetDefaults()
    {
        ...
        {
            CoroutineLauncherService.Instance.CallNextFrame(ApplyAllChannelSettings);
        }
    }
    #endregion
