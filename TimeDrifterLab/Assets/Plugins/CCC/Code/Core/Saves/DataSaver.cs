...
[CreateAssetMenu(menuName = "CCC/DataSaver")]
public class DataSaver : FileScriptableInterface
{
    ...
    public object GetObjectClone(string key, object defaultVal = null)
    {
        if (data.objects.ContainsKey(key))
        {
            ...
            return result != null ? ObjectDeepCopy.Clone(result) : null;
        }
        else
            return defaultVal;
    }
    ...
    {
        object clone = value != null ? ObjectDeepCopy.Clone(value) : null;
