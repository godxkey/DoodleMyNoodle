...
namespace NestedTODO
{
    public class DefaultConfiguration : ScriptableObject
    {
         ...
         */
        public const string ChecklistWindowRoute = "Tools/TaskManager/Checklist Window";
        public const string AgileBoardWindowRoute = "Tools/TaskManager/Agile Board";
        public const string BurndownChartWindowRoute = "Tools/TaskManager/Burndown Chart";
