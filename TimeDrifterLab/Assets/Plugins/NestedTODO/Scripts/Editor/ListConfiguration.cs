...
namespace NestedTODO
{
    ...
    public class ListConfiguration
    {
        ...
        public ListConfiguration(SerializedObject serializedObject)
        {
        ...
        public void Reset(SerializedObject serializedObject, int option = -1)
        {
            ...
            switch (option)
            {
                case 0:
                    ...
                    config.FindPropertyRelative("autoSelectNewTask").boolValue = defaultConfig.defaultShowExtendedToolbar;
