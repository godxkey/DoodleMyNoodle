...
{
    public static readonly ulong crc = 3541780124444698559;
    ...
    public static readonly Dictionary<Type, Func<object, int>> map_GetBitSize = new Dictionary<Type, Func<object, int>>()
    {
        ...
        ,
        [typeof(PlayerInputNextTurn)] = (obj) =>
        {
            PlayerInputNextTurn castedObj = (PlayerInputNextTurn)obj;
            return StaticNetSerializer_PlayerInputNextTurn.GetNetBitSize(castedObj);
        }
        ,
    ...
    public static readonly Dictionary<Type, Action<object, BitStreamWriter>> map_Serialize = new Dictionary<Type, Action<object, BitStreamWriter>>()
    {
        ...
        ,
        [typeof(PlayerInputNextTurn)] = (obj, writer) =>
        {
            PlayerInputNextTurn castedObj = (PlayerInputNextTurn)obj;
            StaticNetSerializer_PlayerInputNextTurn.NetSerialize(castedObj, writer);
        }
        ,
    ...
    public static readonly Dictionary<UInt16, Func<BitStreamReader, object>> map_Deserialize = new Dictionary<UInt16, Func<BitStreamReader, object>>()
    {
        ...
        [43] = (reader) =>
        {
            ...
            StaticNetSerializer_PlayerInputNextTurn.NetDeserialize(obj, reader);
            return obj;
        }
        ,
        [44] = (reader) =>
