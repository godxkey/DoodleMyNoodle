...
public class GameEffectExecuteGameActionOnDamageDealt
{
    public class GameActionBegin : GameAction<GameActionBegin.Settings>
    {
        ...
        protected override bool Execute(in ExecInputs input, ref ExecOutput output, ref Settings settings)
        {
            ...
            input.Accessor.AddComponentData(input.Context.ActionInstigator, new GameEffectOnDamageDealtToApply()
            {
