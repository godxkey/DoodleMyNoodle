...
public static class StaticNetSerializer_GameActionParameterMiniGame_Data
{
    ...
    public static int GetNetBitSize(GameActionParameterMiniGame.Data obj)
    {
        int result = 0;
        result += StaticNetSerializer_fix3.GetNetBitSize(ref obj.DirectionnalForce);
        result += StaticNetSerializer_System_Int32.GetNetBitSize();
        result += StaticNetSerializer_Unity_Mathematics_int2.GetNetBitSize(ref obj.Position);
        result += StaticNetSerializer_GameAction_ParameterData.GetNetBitSize(obj);
        return result;
    }

    public static void NetSerialize_Class(GameActionParameterMiniGame.Data obj, BitStreamWriter writer)
    {
        if (obj == null)
        {
            writer.WriteBit(false);
    ...
    public static void NetSerialize(GameActionParameterMiniGame.Data obj, BitStreamWriter writer)
    {
        StaticNetSerializer_fix3.NetSerialize(ref obj.DirectionnalForce, writer);
        StaticNetSerializer_System_Int32.NetSerialize((System.Int32)obj.SuccessRate, writer);
        StaticNetSerializer_Unity_Mathematics_int2.NetSerialize(ref obj.Position, writer);
        StaticNetSerializer_GameAction_ParameterData.NetSerialize(obj, writer);
    }

    public static GameActionParameterMiniGame.Data NetDeserialize_Class(BitStreamReader reader)
    {
        if (reader.ReadBit() == false)
        {
            return null;
    ...
    public static void NetDeserialize(GameActionParameterMiniGame.Data obj, BitStreamReader reader)
    {
        StaticNetSerializer_fix3.NetDeserialize(ref obj.DirectionnalForce, reader);
        obj.SuccessRate = (MiniGameDescriptionBase.SuccessRate)StaticNetSerializer_System_Int32.NetDeserialize(reader);
        StaticNetSerializer_Unity_Mathematics_int2.NetDeserialize(ref obj.Position, reader);
        StaticNetSerializer_GameAction_ParameterData.NetDeserialize(obj, reader);
    }
}
...
public static class StaticNetSerializer_SimInputCheatDamagePlayer
{
    ...
    public static int GetNetBitSize(SimInputCheatDamagePlayer obj)
    {
        int result = 0;
        result += StaticNetSerializer_PersistentId.GetNetBitSize(ref obj.PlayerId);
        result += StaticNetSerializer_System_Int32.GetNetBitSize(ref obj.Damage);
        result += StaticNetSerializer_SimCheatInput.GetNetBitSize(obj);
        return result;
    }

    public static void NetSerialize_Class(SimInputCheatDamagePlayer obj, BitStreamWriter writer)
    {
        if (obj == null)
        {
            writer.WriteBit(false);
    ...
    public static void NetSerialize(SimInputCheatDamagePlayer obj, BitStreamWriter writer)
    {
        StaticNetSerializer_PersistentId.NetSerialize(ref obj.PlayerId, writer);
        StaticNetSerializer_System_Int32.NetSerialize(ref obj.Damage, writer);
        StaticNetSerializer_SimCheatInput.NetSerialize(obj, writer);
    }

    public static SimInputCheatDamagePlayer NetDeserialize_Class(BitStreamReader reader)
    {
        if (reader.ReadBit() == false)
        {
            return null;
    ...
    public static void NetDeserialize(SimInputCheatDamagePlayer obj, BitStreamReader reader)
    {
        StaticNetSerializer_PersistentId.NetDeserialize(ref obj.PlayerId, reader);
        StaticNetSerializer_System_Int32.NetDeserialize(ref obj.Damage, reader);
        StaticNetSerializer_SimCheatInput.NetDeserialize(obj, reader);
    }
}
public static class StaticNetSerializer_SimInputCheatInfiniteAP
{
    public static int GetNetBitSize_Class(SimInputCheatInfiniteAP obj)
    {
        if (obj == null)
            return 1;
        return 1 + GetNetBitSize(obj);
    ...
    public static int GetNetBitSize(SimInputCheatInfiniteAP obj)
    {
        int result = 0;
        result += StaticNetSerializer_PersistentId.GetNetBitSize(ref obj.PlayerId);
        result += StaticNetSerializer_SimCheatInput.GetNetBitSize(obj);
    ...
    public static void NetSerialize_Class(SimInputCheatInfiniteAP obj, BitStreamWriter writer)
    {
        if (obj == null)
        {
            writer.WriteBit(false);
    ...
    public static void NetSerialize(SimInputCheatInfiniteAP obj, BitStreamWriter writer)
    {
        StaticNetSerializer_PersistentId.NetSerialize(ref obj.PlayerId, writer);
        StaticNetSerializer_SimCheatInput.NetSerialize(obj, writer);
    }

    public static SimInputCheatInfiniteAP NetDeserialize_Class(BitStreamReader reader)
    {
        if (reader.ReadBit() == false)
        {
            return null;
    ...
    public static void NetDeserialize(SimInputCheatInfiniteAP obj, BitStreamReader reader)
    {
        StaticNetSerializer_PersistentId.NetDeserialize(ref obj.PlayerId, reader);
        StaticNetSerializer_SimCheatInput.NetDeserialize(obj, reader);
    }
...
{
    public static int GetNetBitSize_Class(SimInputCheatNextTurn obj)
    {
        if (obj == null)
            return 1;
        return 1 + GetNetBitSize(obj);
    ...
    public static int GetNetBitSize(SimInputCheatNextTurn obj)
    {
        int result = 0;
        result += StaticNetSerializer_SimCheatInput.GetNetBitSize(obj);
        return result;
    ...
    public static void NetSerialize_Class(SimInputCheatNextTurn obj, BitStreamWriter writer)
    {
        if (obj == null)
        {
            writer.WriteBit(false);
    ...
    public static void NetSerialize(SimInputCheatNextTurn obj, BitStreamWriter writer)
    {
        StaticNetSerializer_SimCheatInput.NetSerialize(obj, writer);
    }

    public static SimInputCheatNextTurn NetDeserialize_Class(BitStreamReader reader)
    {
        if (reader.ReadBit() == false)
        {
            return null;
    ...
    public static void NetDeserialize(SimInputCheatNextTurn obj, BitStreamReader reader)
    {
        StaticNetSerializer_SimCheatInput.NetDeserialize(obj, reader);
    }
}
...
{
    public static int GetNetBitSize_Class(SimInputCheatToggleInvincible obj)
    {
        if (obj == null)
            return 1;
        return 1 + GetNetBitSize(obj);
    ...
    public static int GetNetBitSize(SimInputCheatToggleInvincible obj)
    {
        int result = 0;
        result += StaticNetSerializer_PersistentId.GetNetBitSize(ref obj.PlayerId);
        result += StaticNetSerializer_SimCheatInput.GetNetBitSize(obj);
    ...
    public static void NetSerialize_Class(SimInputCheatToggleInvincible obj, BitStreamWriter writer)
    {
        if (obj == null)
        {
            writer.WriteBit(false);
    ...
    public static void NetSerialize(SimInputCheatToggleInvincible obj, BitStreamWriter writer)
    {
        StaticNetSerializer_PersistentId.NetSerialize(ref obj.PlayerId, writer);
        StaticNetSerializer_SimCheatInput.NetSerialize(obj, writer);
    }

    public static SimInputCheatToggleInvincible NetDeserialize_Class(BitStreamReader reader)
    {
        if (reader.ReadBit() == false)
        {
            return null;
    ...
    public static void NetDeserialize(SimInputCheatToggleInvincible obj, BitStreamReader reader)
    {
        StaticNetSerializer_PersistentId.NetDeserialize(ref obj.PlayerId, reader);
        StaticNetSerializer_SimCheatInput.NetDeserialize(obj, reader);
    }
...
{
    public static int GetNetBitSize_Class(SimInputSetPlayerActive obj)
    {
        if (obj == null)
            return 1;
        return 1 + GetNetBitSize(obj);
    ...
    public static int GetNetBitSize(SimInputSetPlayerActive obj)
    {
        int result = 0;
        result += StaticNetSerializer_PersistentId.GetNetBitSize(ref obj.PlayerID);
        result += StaticNetSerializer_System_Boolean.GetNetBitSize(ref obj.IsActive);
        result += StaticNetSerializer_SimMasterInput.GetNetBitSize(obj);
        return result;
    }

    public static void NetSerialize_Class(SimInputSetPlayerActive obj, BitStreamWriter writer)
    {
        if (obj == null)
        {
            writer.WriteBit(false);
    ...
    public static void NetSerialize(SimInputSetPlayerActive obj, BitStreamWriter writer)
    {
        StaticNetSerializer_PersistentId.NetSerialize(ref obj.PlayerID, writer);
        StaticNetSerializer_System_Boolean.NetSerialize(ref obj.IsActive, writer);
        StaticNetSerializer_SimMasterInput.NetSerialize(obj, writer);
    }

    public static SimInputSetPlayerActive NetDeserialize_Class(BitStreamReader reader)
    {
        if (reader.ReadBit() == false)
        {
            return null;
    ...
    public static void NetDeserialize(SimInputSetPlayerActive obj, BitStreamReader reader)
    {
        StaticNetSerializer_PersistentId.NetDeserialize(ref obj.PlayerID, reader);
        StaticNetSerializer_System_Boolean.NetDeserialize(ref obj.IsActive, reader);
        StaticNetSerializer_SimMasterInput.NetDeserialize(obj, reader);
    }
}
