...
//public class GameActionGrantStat : GameAction<GameActionGrantStat.Settings>
//{
//    [Serializable]
//    [GameActionSettingAuth(typeof(Settings))]
//    public class SettingsAuth : GameActionSettingAuthBase
...
//        public fix Range;
//        public fix Value;
//        public Settings.EStatType StatType;
...
//            {
//                case Settings.EStatType.AP:
//                {
//                    CommonWrites.AddStatFix<ActionPoints>(accessor, paramEntity.Entity, settings.Value);
//                    break;
//                }
//                case Settings.EStatType.Health:
//                    CommonWrites.RequestHeal(accessor, context.InstigatorPawn, paramEntity.Entity, heal);
//                    CommonWrites.AddStatFix<ActionPoints>(accessor, paramEntity.Entity, settings.Value);
//                    break;
//                case Settings.EStatType.MoveSpeed:
//                    break;
//                default:
//                    break;
//            }
