...
public static class SceneShortcuts
{
    ...
    [MenuItem("Scene Shortcuts/Lvl_Prototype5_Alex", priority = 4016)]
    ...
    [MenuItem("Scene Shortcuts/Lvl_Prototype5_Presentation", priority = 4017)]
    public static void Assets_Scenes_Levels_Scene_Assets_Lvl_Prototype5_Presentation() => LoadScene("Assets/Scenes/Levels/Scene Assets/Lvl_Prototype5_Presentation.unity");

    [MenuItem("Scene Shortcuts/Lvl_Prototype6", priority = 4018)]
    public static void Assets_Scenes_Levels_Scene_Assets_Lvl_Prototype6() => LoadScene("Assets/Scenes/Levels/Scene Assets/Lvl_Prototype6.unity");

    [MenuItem("Scene Shortcuts/Lvl_Prototype6_Presentation", priority = 4019)]
    public static void Assets_Scenes_Levels_Scene_Assets_Lvl_Prototype6_Presentation() => LoadScene("Assets/Scenes/Levels/Scene Assets/Lvl_Prototype6_Presentation.unity");

    [MenuItem("Scene Shortcuts/Lvl_SideScrollerExemple", priority = 4020)]
    ...
    [MenuItem("Scene Shortcuts/Menu_InGameEscape", priority = 5021)]
    ...
    [MenuItem("Scene Shortcuts/Menu_OnlineClientSessionChoice", priority = 5022)]
    ...
    [MenuItem("Scene Shortcuts/Menu_OnlineRoleChoice", priority = 5023)]
    ...
    [MenuItem("Scene Shortcuts/Menu_OnlineServerSessionCreation", priority = 5024)]
    ...
    [MenuItem("Scene Shortcuts/Misc_LoadingScreen", priority = 6025)]
