...
public class DoodleLibraryDoodleDisplay : MonoBehaviour
{
    ...
    private System.Action<int> _onDoodleDisplayDeleted;

    private int _doodleIndex;

    public void SetDoodleDisplay(Texture2D doodle, int index, Action<Texture2D, int> onDoodleDisplaySelected, System.Action<int> onDoodleDisplayDeleted)
    {
