...
internal static class F64
{
    ...
    public static readonly Fix64 OneEighth = Fix64.One / new Fix64(8);
    public static readonly Fix64 FourThirds = new Fix64(4) / new Fix64(3);
    public static readonly Fix64 TwoFifths = new Fix64(2) / new Fix64(5);
