...
public struct FixMatrix
{
    ...
    public static FixMatrix CreateFromAxisAngle(FixVector3 axis, Fix64 angle)
    {
        FixMatrix toReturn;
    ...
    public static void Multiply(ref FixMatrix matrix, Fix64 scale, out FixMatrix result)
    {
    ...
    public static FixMatrix operator *(FixMatrix m, Fix64 f)
    {
        FixMatrix result;
    ...
    /// <param name="f">Scaling value to apply to all components of the matrix.</param>
    /// <returns>Product of the multiplication.</returns>
    public static FixMatrix operator *(Fix64 f, FixMatrix m)
    {
        FixMatrix result;
        Multiply(ref m, f, out result);
        return result;
    ...
    public static void CreateOrthographicRH(Fix64 left, Fix64 right, Fix64 bottom, Fix64 top, Fix64 zNear, Fix64 zFar, out FixMatrix projection)
    {
    ...
    public static void CreatePerspectiveFieldOfViewRH(Fix64 fieldOfView, Fix64 aspectRatio, Fix64 nearClip, Fix64 farClip, out FixMatrix perspective)
    {
    ...
    public static FixMatrix CreatePerspectiveFieldOfViewRH(Fix64 fieldOfView, Fix64 aspectRatio, Fix64 nearClip, Fix64 farClip)
    {
    ...
    /// <param name="scaleMatrix">FixMatrix representing the given scale.</param>
    public static void CreateScale(Fix64 x, Fix64 y, Fix64 z, out FixMatrix scaleMatrix)
    {
        scaleMatrix = new FixMatrix
        {
            M11 = x,
    ...
    /// <param name="z">Scale along the z axis.</param>
    /// <returns>FixMatrix representing the given scale.</returns>
    public static FixMatrix CreateScale(Fix64 x, Fix64 y, Fix64 z)
    {
        FixMatrix scaleMatrix;
