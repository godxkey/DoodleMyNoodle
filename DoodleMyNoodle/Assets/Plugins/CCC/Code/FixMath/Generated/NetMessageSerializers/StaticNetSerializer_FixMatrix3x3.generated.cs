...
public static class StaticNetSerializer_FixMatrix3x3
{
    public static int GetNetBitSize(ref FixMatrix3x3 obj)
    {
        int result = 0;
    ...
    public static void NetSerialize(ref FixMatrix3x3 obj, BitStreamWriter writer)
    {
    ...
    public static void NetDeserialize(ref FixMatrix3x3 obj, BitStreamReader reader)
    {
