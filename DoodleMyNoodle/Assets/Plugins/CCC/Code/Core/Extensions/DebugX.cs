...
public static class DebugX
{
    ...
    public static void DebugCylinder(Vector3 start, Vector3 end, Color color, float radius = 1, float duration = 0, bool depthTest = true)
    {
        ...
        //Radial circles
        DebugX.DebugCircle(start, up, color, radius, duration, depthTest);
        DebugX.DebugCircle(end, -up, color, radius, duration, depthTest);
        DebugX.DebugCircle((start + end) * 0.5f, up, color, radius, duration, depthTest);
    ...
    public static void DebugCone(Vector3 position, Vector3 direction, Color color, float angle = 45, float duration = 0, bool depthTest = true)
    {
        ...
        DebugX.DebugCircle(position + _forward, direction, color, (_forward - (slerpedVector.normalized * dist)).magnitude, duration, depthTest);
        DebugX.DebugCircle(position + (_forward * 0.5f), direction, color, ((_forward * 0.5f) - (slerpedVector.normalized * (dist * 0.5f))).magnitude, duration, depthTest);
    }
    ...
    public static void DebugArrow(Vector3 position, Vector3 direction, Color color, float duration = 0, bool depthTest = true)
    {
        ...
        DebugX.DebugCone(position + direction, -direction * 0.333f, color, 15, duration, depthTest);
    }
    ...
    public static void DrawCylinder(Vector3 start, Vector3 end, Color color, float radius = 1.0f)
    {
        ...
        //Radial circles
        DebugX.DrawCircle(start, up, color, radius);
        DebugX.DrawCircle(end, -up, color, radius);
        DebugX.DrawCircle((start + end) * 0.5f, up, color, radius);
    ...
    public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45)
    {
        ...
        DebugX.DrawCircle(position + _forward, direction, color, (_forward - (slerpedVector.normalized * dist)).magnitude);
        DebugX.DrawCircle(position + (_forward * 0.5f), direction, color, ((_forward * 0.5f) - (slerpedVector.normalized * (dist * 0.5f))).magnitude);
    ...
    public static void DrawArrow(Vector3 position, Vector3 direction, Color color)
    {
        ...
        DebugX.DrawCone(position + direction, -direction * 0.333f, color, 15);
